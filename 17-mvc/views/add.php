    ...
    <body>
        <main class="my-10 mx-auto p-10 w-8/12 bg-white/50 rounded-xl">
            <headre class="text-black/60 flex gap-4 justify-center items-center pb-4 border-b-2 border-white/90">
                ...
                <h1 class="text-3xl ">Add Users</h1>
            </headre>
            <section>
                <a href="./" class="flex mt-8 p-2 justify-center items-center gap-2 bg-blue-600 rounded w-2/12 hover:scale-105 text-white hover:bg-blue-400">
                ...
                <div class="relative z-0 mb-6 w-full group">
                    <input type="text" name="fullname" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required="">
                ...
                <input class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="multiple_files" type="file" multiple="" name="photo">
