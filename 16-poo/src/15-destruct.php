                ...
                <?php
                    class Database{
                        ...
                        public function connect()
                        {
                           ...
                           if($this->conx){
                                echo "<div class='mb-2 bg-green-300 p-2 text-black text-center rounded'> Connection DataBase Succesfully!</div>";
                           }
                        }
                        public function disconnect()
                        {
                            $this->conx = mysqli_connect('127.0.0.1','root','','adsi2338200');
                            if($this->conx){
                                 echo "<div class='mb-2 bg-red-300 p-2 text-black text-center rounded'> Disconnection DataBase Succesfully!</div>";
                            }
                        }
