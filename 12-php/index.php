    ...
    <div class="row">
        <div class="col-6 offset-3 text-center">
            ...
            <div class="btn-group-vertical" role="group" aria-label="Vertical button group" style="width: 24rem">
                ...
                <a href="02-info.php" target="_bank" class="btn btn-outline-info text-start"><span class="badge rounded-pill bg-dark">02</span> info</a>
                ...
                <a href="05-strings.php.php" class="btn btn-outline-info text-start"><span class="badge rounded-pill bg-dark">05</span> strings</a>
                ...
                <a href="07-oper-assignemt.php" class="btn btn-outline-info text-start"><span class="badge rounded-pill bg-dark">07</span> oper-assignemt</a>
